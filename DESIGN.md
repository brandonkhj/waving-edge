<!--
  Waving Edge Venture adaptations of this design system:
  - Display face: Space Grotesk 600 with negative tracking stands in for Cal Sans.
  - Brand accent: Waving Edge teal oklch(52% 0.09 200) replaces #3b82f6 — used only for
    the wave logo, small dots/flourishes, and decorative wave lines. Never on CTAs.
  - The wave motif (logo + thin wave lines in stats panel / contact card) is retained as
    the brand voltage layer, playing the role Cal.com gives product-UI fragments.
  Source: https://github.com/VoltAgent/awesome-design-md (design-md/cal/DESIGN.md)
-->
---
version: alpha
